...
description: This post demonstrates how to present slideshows with the `Xaringan`
  package. I explain how to integrate slideshows with `Xaringan` into blogdown via
