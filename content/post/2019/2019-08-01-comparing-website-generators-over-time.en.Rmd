...
description: 'This article is the follow-up of [Retrieving And Scrapping Archived Data With The Wayback Machine](https://rpubs.com/pbaumgartner/wayback). Here I will display some results from the scrapped archived web site https://www.staticgen.com/ at seven dates, starting from May 2014 to August 2019. The data for this article comes from the previous article mentioned above'
disable_comments: no
draft: no
---
