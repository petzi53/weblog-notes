...
<img class="border shadow" src="/post/2019/2019-06-21-toward-a-taxonomy-of-open-science.en.files/Open-Science-0-min.png" usemap="#open-science-map" alt="Open Science Taxonomie" /> <figcaption><h4>**Figure 01:** TThe first level of a sugeested Taxonomy of Open Science (TOS)</h4></figcaption>
...
<map name="open-science-map">
  ...
  <area alt="Open Science" title="Open Science" href="/2019/06/21/toward-a-taxonomy-of-open-science/" coords="136,270,370,349" shape="rect">
</map>
...
<img class="border shadow" src="/post/2019/2019-06-23-open-citation-toward-a-taxonomy-of-open-science.en.files/open-citation.png" alt="" /> <figcaption><h4>**Figure 01:** How many citation referenced by Crossref are Open Citations? (see: [https://web.archive.org/web/20190623212728/https://i4oc.org/](https://web.archive.org/web/20190623212728/https://i4oc.org/), accessed 2019-06-23.</h4></figcaption>
...
<img class="border shadow" src="/post/2019/2019-06-23-open-citations-TOS.en.files/WoS-Clarivate-Product-Portfolio.png" alt="Graphic about the structure of Web of Science services" width=40% /> <figcaption><h4>**Figure 2:** Clarivate Analytics [Web of Science product portfolio](https://clarivate.libguides.com/webofscienceplatform/introduction)</h4></figcaption>

WoS is not only one product but platform with many different indexing services and several scientific literature search databases. The central product in the portfolio of Clarivate Analytics is the Web of Science Core Collection (see Figure 2). It includes:
...
See to the subject of Open Citation also my permanently updated pointers on my [Wakelet page](https://wakelet.com/@PeterBaumgartner).
