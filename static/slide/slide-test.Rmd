...
output:
  revealjs::revealjs_presentation:
    ...
    fig_caption: true
slug: slide-test
description: This is a test with Reveal.js slides!
---

## Test [Wayback Machine](https://web.archive.org/) (Slides)
...
## 1. Wayback Machine (Test) [Start Page](https://web.archive.org/)

<img src="../img/wayback-machine-tutorial/01-web.archive.org-home-min.png" style="width: 50%" />
